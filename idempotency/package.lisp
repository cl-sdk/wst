...
(defun make-idempotency-engine ()
  (error (concatenate 'string
                      "No default store-backed idempotency engine is provided in "
                      "io.github.cl-sdk.wst.idempotency. "
                      "Use a concrete engine implementation such as "
                      "(make-instance 'io.github.cl-sdk.wst.idempotency.memory-store:memory-idempotency-engine) "
