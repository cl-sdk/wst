(defpackage #:io.github.cl-sdk.wst.rate-limit.memory-store
  (:use #:cl #:io.github.cl-sdk.wst.rate-limit.store)
...
(in-package #:io.github.cl-sdk.wst.rate-limit.memory-store)
...
(defmethod fetch-window ((store memory-store) key)
